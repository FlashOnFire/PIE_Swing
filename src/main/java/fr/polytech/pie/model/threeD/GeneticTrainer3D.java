...
public class GeneticTrainer3D {
    ...
    public GeneticTrainer3D(int populationSize, int gamesPerEvaluation) {
        ...
        for (int piece = 0; piece < maxPieces; piece++) {
            ...
            for (int i = 0; i < grid.getWidth(); i++) {
                for (int j = 0; j < grid.getDepth(); j++) {
                    maxHeight = Math.max(maxHeight, grid.getHeightOfColumn3D(i, j));
                }
            }
    ...
    public static void main(String[] args) {
        ...
        GeneticTrainer3D trainer = new GeneticTrainer3D(populationSize, gamesPerEvaluation);
        ...
        System.out.println("Layer Completeness Weight: " + bestParameters[5]);
    ...
    private static void printHelp() {
        System.out.println("GeneticTrainer3D - Optimize 3D Tetris AI parameters");
        System.out.println();
    ...
    private static void saveParametersToFile(double[] parameters, String filename) {
        try (java.io.PrintWriter writer = new java.io.PrintWriter(new java.io.FileWriter(filename))) {
            writer.println("// 3D Tetris AI parameters generated by GeneticTrainer3D");
